...
class Users_list extends CI_Controller {
 ...
 public function index(){
       ...
       $data=[];
       $data['script']="users_list/script"; 
    
       $data['content']="users_list/index";
     ...
     public function list(){
      ...
      //  $data['count']=   $this->db->count_all_results(TBL_LANDLORD);
         ...
         $data['count']=$this->admin_model->CountUsersList($keyword);
  
         $data['recordsFiltered']=$data['count'];
         $data['aaData']=$this->admin_model->UsersList(10,$offset,$keyword,$orderkey,$ordervalue);
