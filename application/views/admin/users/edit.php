                    ...
                    <div class="col-md-6">
                       <div class="form-group">
                        <label for="user_name">User Name</label>
                         <input type="text"  name="user_name"  <?php if(form_error('user_name')){ echo 'style="border-color:red"'; } ?>  value="<?php if(set_value('user_name')){ echo set_value('user_name'); }elseif(!empty($row->user_name)){ echo $row->user_name; } ?>"   class="form-control" id="user_name" placeholder="User Name">
