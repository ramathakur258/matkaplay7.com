                    ...
                    <div class="col-6 col-md-6 text-right">
                        <div class="top-social">
                            <ul class="social-list">
                                 ...
                                 <li><a  style="background-color:#a900ff; color:#fff;" href="<?php echo base_url('login')?>">Login</a></li>
                                   <li><a style="background-color:#a900ff; color:#fff;" href="<?php echo base_url('register')?>">Signup</a></li>
                            <?php    }else{ ?>
     ...
     <footer class="layout-dark">
        ...
        <div class="copy-right">
            <div class="container padding-tb-50px">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="copy-right-text text-lg-left text-center sm-mb-15px">© 2021 Online Play Matka - All rights reserved </div>
                    </div>
                    <div class="col-lg-6">
                        <!--  Social -->
